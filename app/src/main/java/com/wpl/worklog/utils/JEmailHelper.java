...
/**
 * JEmailHelper
 * Created by wpl on 15/8/31.
 */
public class JEmailHelper {

    private int port = 25;  //smtp协议使用的端口
    private String host = "smtp.163.com"; // 发件人邮件服务器
    private String user = "18244267955@163.com";   // 使用者账号
    private String password = "Wei199532"; //使用者密码
    ...
    public enum SendStatus {
        SENDING, UNDO, SEND_OK, SEND_FAIL
    }

    private SendStatus sendStatus;

    public interface JieEmailInterface {
        void startSend();

        void SendStatus(SendStatus sendStatus);
    }

    private JieEmailInterface jieEmailInterface;

    public void setJieEmailInterface(JieEmailInterface jieEmailInterface) {
        this.jieEmailInterface = jieEmailInterface;
    }
    ...
    private class JieAuthenticator extends Authenticator {
        private String strUser;
        private String strPwd;

        JieAuthenticator(String user, String password) {
            this.strUser = user;
    ...
    private class JibeAsyncTask extends AsyncTask<Void, Void, SendStatus> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            if (jieEmailInterface != null) {
                jieEmailInterface.startSend();
            }
        }
        ...
        protected void onPostExecute(SendStatus result) {
            ...
            if (jieEmailInterface != null) {
                jieEmailInterface.SendStatus(result);
            }
            sendStatus = SendStatus.UNDO;
        }
